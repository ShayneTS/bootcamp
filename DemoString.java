public class DemoString {
  public static void main(String[] args) {
   ...
   // System.out.println(s8.charAt(-1));//error
    ...
    // Java -> Type
    // ! chain method
    s14.toUpperCase().charAt(1); //.charAt(1); // E
    System.out.println(s14.substring(4).length()); //.charAt()); // 10
    ...
    System.out.println(s17.startsWith("Pyt")); //trye
    ...
    System.out.println(s17.endsWith("thon"));
    System.out.println(s17.endsWith("O"));
    ...
    System.out.println(s20.indexOf('l')); // 2, because start from 0, 0>1>2
    ...
    System.out.println("abcd".concat("ijk").concat("xyz"));
    ...
    System.out.println(username2.trim().length()); // 10 (what happened?)
    System.out.println(username.trim().length()); // 10 (what happened?)
